...
final class CustomDecl {
    static List<Decl> make() {
        List<Decl> decls = new ArrayList<>();

        decls.add(
                Decls.newVar(
                        "now",
                        Decls.newObjectType(TimestampT.TimestampType.typeName())
                ));
        ...
        decls.add(
                Decls.newFunction(
                        ...
                        Decls.newInstanceOverload("is_ip_unary", Collections.singletonList(Decls.String), Decls.Bool)
                ));

        decls.add(
                Decls.newFunction(
                        "isUriRef",
                        Decls.newInstanceOverload("is_uri_ref", Collections.singletonList(Decls.String), Decls.Bool)
                ));

        decls.add(
                Decls.newFunction(
                        "isUri",
                        Decls.newInstanceOverload("is_uri", Collections.singletonList(Decls.String), Decls.Bool)
                ));

        decls.add(
                Decls.newFunction(
                        "isEmail",
                        Decls.newInstanceOverload("is_email", Collections.singletonList(Decls.String), Decls.Bool)
                ));

        decls.add(
                Decls.newFunction(
                        "isHostname",
                        Decls.newInstanceOverload("is_hostname", Collections.singletonList(Decls.String), Decls.Bool)
                ));

        decls.add(
                Decls.newFunction(
                        "startsWith",
                        Decls.newInstanceOverload("starts_with_bytes", Arrays.asList(Decls.Bytes, Decls.Bytes), Decls.Bool)
                ));

        decls.add(
                Decls.newFunction(
                        "endsWith",
                        Decls.newInstanceOverload("ends_with_bytes", Arrays.asList(Decls.Bytes, Decls.Bytes), Decls.Bool)
                ));

        decls.add(
                Decls.newFunction(
                        "contains",
                        Decls.newInstanceOverload("contains_bytes", Arrays.asList(Decls.Bytes, Decls.Bytes), Decls.Bool)
                ));
