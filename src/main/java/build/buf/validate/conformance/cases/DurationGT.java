...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.DurationGT other = (build.buf.validate.conformance.cases.DurationGT) obj;
  ...
  public static final class Builder extends
    ...
    public build.buf.validate.conformance.cases.DurationGT buildPartial() {
      build.buf.validate.conformance.cases.DurationGT result = new build.buf.validate.conformance.cases.DurationGT(this);
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.DurationGT other) {
      if (other == build.buf.validate.conformance.cases.DurationGT.getDefaultInstance()) return this;
      if (other.hasVal()) {
  ...
  private static final com.google.protobuf.Parser<DurationGT>
      PARSER = new com.google.protobuf.AbstractParser<DurationGT>() {
    @java.lang.Override
