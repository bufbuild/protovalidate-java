...
public interface MapRecursiveOrBuilder
    extends
  ...
  java.util.Map<java.lang.Integer, build.buf.validate.conformance.cases.MapRecursive.Msg> getVal();
   ...
   * </code>
   */
  build.buf.validate.conformance.cases.MapRecursive.Msg getValOrThrow(int key);
}
