...
public interface SuiteResultsOrBuilder
    extends
   ...
   * </code>
   */
  java.util.List<build.buf.validate.conformance.harness.CaseResult> getCasesList();
   ...
   * </code>
   */
  build.buf.validate.conformance.harness.CaseResultOrBuilder getCasesOrBuilder(int index);
