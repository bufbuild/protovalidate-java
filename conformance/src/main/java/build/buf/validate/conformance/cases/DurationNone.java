...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.DurationNone other = (build.buf.validate.conformance.cases.DurationNone) obj;
  ...
  public static final class Builder extends
    ...
    public build.buf.validate.conformance.cases.DurationNone buildPartial() {
      build.buf.validate.conformance.cases.DurationNone result = new build.buf.validate.conformance.cases.DurationNone(this);
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.DurationNone other) {
      if (other == build.buf.validate.conformance.cases.DurationNone.getDefaultInstance()) return this;
      if (other.hasVal()) {
  ...
  private static final com.google.protobuf.Parser<DurationNone>
      PARSER = new com.google.protobuf.AbstractParser<DurationNone>() {
    @java.lang.Override
