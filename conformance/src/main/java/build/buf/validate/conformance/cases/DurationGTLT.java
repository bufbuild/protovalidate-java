...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.DurationGTLT other = (build.buf.validate.conformance.cases.DurationGTLT) obj;
  ...
  public static final class Builder extends
    ...
    public build.buf.validate.conformance.cases.DurationGTLT buildPartial() {
      build.buf.validate.conformance.cases.DurationGTLT result = new build.buf.validate.conformance.cases.DurationGTLT(this);
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.DurationGTLT other) {
      if (other == build.buf.validate.conformance.cases.DurationGTLT.getDefaultInstance()) return this;
      if (other.hasVal()) {
  ...
  private static final com.google.protobuf.Parser<DurationGTLT>
      PARSER = new com.google.protobuf.AbstractParser<DurationGTLT>() {
    @java.lang.Override
