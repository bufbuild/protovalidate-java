...
public interface ResultSetOrBuilder
   ...
   * </code>
   */
  java.util.List<build.buf.validate.conformance.harness.SuiteResults> getSuitesList();
   ...
   * </code>
   */
  build.buf.validate.conformance.harness.SuiteResultsOrBuilder getSuitesOrBuilder(int index);
