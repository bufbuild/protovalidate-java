...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.DurationIn other = (build.buf.validate.conformance.cases.DurationIn) obj;
  ...
  public static final class Builder extends
    ...
    public build.buf.validate.conformance.cases.DurationIn buildPartial() {
      build.buf.validate.conformance.cases.DurationIn result = new build.buf.validate.conformance.cases.DurationIn(this);
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.DurationIn other) {
      if (other == build.buf.validate.conformance.cases.DurationIn.getDefaultInstance()) return this;
      if (other.hasVal()) {
  ...
  private static final com.google.protobuf.Parser<DurationIn>
      PARSER = new com.google.protobuf.AbstractParser<DurationIn>() {
    @java.lang.Override
