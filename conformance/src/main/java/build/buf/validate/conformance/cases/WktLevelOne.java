...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      WktLevelOne.class.getName());
  }
  // Use WktLevelOne.newBuilder() to construct.
  private WktLevelOne(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private WktLevelOne() {
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        WktLevelTwo.class.getName());
    }
    // Use WktLevelTwo.newBuilder() to construct.
    private WktLevelTwo(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    private WktLevelTwo() {
    }
    ...
    private static final long serialVersionUID = 0L;
      static {
        com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
          ...
          /* patch= */ 2,
          /* suffix= */ "",
          WktLevelThree.class.getName());
      }
      // Use WktLevelThree.newBuilder() to construct.
      private WktLevelThree(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
    ...
    public static final class Builder extends
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                input.readMessage(
                    internalGetThreeFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
      ...
      public build.buf.validate.conformance.cases.WktLevelOne.WktLevelTwo.WktLevelThree.Builder getThreeBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetThreeFieldBuilder().getBuilder();
      }
      /**
       * <code>.buf.validate.conformance.cases.WktLevelOne.WktLevelTwo.WktLevelThree three = 1 [json_name = "three", (.buf.validate.field) = { ... }</code>
       */
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          internalGetThreeFieldBuilder() {
        if (threeBuilder_ == null) {
          threeBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              build.buf.validate.conformance.cases.WktLevelOne.WktLevelTwo.WktLevelThree, build.buf.validate.conformance.cases.WktLevelOne.WktLevelTwo.WktLevelThree.Builder, build.buf.validate.conformance.cases.WktLevelOne.WktLevelTwo.WktLevelThreeOrBuilder>(
                  getThree(),
  ...
  public static final class Builder extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  internalGetTwoFieldBuilder().getBuilder(),
                  extensionRegistry);
              bitField0_ |= 0x00000001;
              break;
            } // case 10
    ...
    public build.buf.validate.conformance.cases.WktLevelOne.WktLevelTwo.Builder getTwoBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetTwoFieldBuilder().getBuilder();
    }
    /**
     * <code>.buf.validate.conformance.cases.WktLevelOne.WktLevelTwo two = 1 [json_name = "two", (.buf.validate.field) = { ... }</code>
     */
