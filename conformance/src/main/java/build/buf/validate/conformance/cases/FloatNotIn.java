...
public final class FloatNotIn extends com.google.protobuf.GeneratedMessageV3
    implements
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return build.buf.validate.conformance.cases.NumbersProto
        ...
        .ensureFieldAccessorsInitialized(
            build.buf.validate.conformance.cases.FloatNotIn.class,
            build.buf.validate.conformance.cases.FloatNotIn.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.FloatNotIn other =
        (build.buf.validate.conformance.cases.FloatNotIn) obj;
  ...
  public static build.buf.validate.conformance.cases.FloatNotIn parseFrom(java.nio.ByteBuffer data)
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public build.buf.validate.conformance.cases.FloatNotIn buildPartial() {
      build.buf.validate.conformance.cases.FloatNotIn result =
          new build.buf.validate.conformance.cases.FloatNotIn(this);
      if (bitField0_ != 0) {
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.FloatNotIn other) {
      if (other == build.buf.validate.conformance.cases.FloatNotIn.getDefaultInstance())
        return this;
      if (other.getVal() != 0F) {
        setVal(other.getVal());
      }
  ...
  private static final com.google.protobuf.Parser<FloatNotIn> PARSER =
      new com.google.protobuf.AbstractParser<FloatNotIn>() {
        @java.lang.Override
