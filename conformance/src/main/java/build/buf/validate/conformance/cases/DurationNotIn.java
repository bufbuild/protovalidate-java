...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.DurationNotIn other = (build.buf.validate.conformance.cases.DurationNotIn) obj;
  ...
  public static final class Builder extends
    ...
    public build.buf.validate.conformance.cases.DurationNotIn buildPartial() {
      build.buf.validate.conformance.cases.DurationNotIn result = new build.buf.validate.conformance.cases.DurationNotIn(this);
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.DurationNotIn other) {
      if (other == build.buf.validate.conformance.cases.DurationNotIn.getDefaultInstance()) return this;
      if (other.hasVal()) {
  ...
  private static final com.google.protobuf.Parser<DurationNotIn>
      PARSER = new com.google.protobuf.AbstractParser<DurationNotIn>() {
    @java.lang.Override
