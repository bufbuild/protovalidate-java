...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.DurationGTELTE other = (build.buf.validate.conformance.cases.DurationGTELTE) obj;
  ...
  public static final class Builder extends
    ...
    public build.buf.validate.conformance.cases.DurationGTELTE buildPartial() {
      build.buf.validate.conformance.cases.DurationGTELTE result = new build.buf.validate.conformance.cases.DurationGTELTE(this);
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.DurationGTELTE other) {
      if (other == build.buf.validate.conformance.cases.DurationGTELTE.getDefaultInstance()) return this;
      if (other.hasVal()) {
  ...
  private static final com.google.protobuf.Parser<DurationGTELTE>
      PARSER = new com.google.protobuf.AbstractParser<DurationGTELTE>() {
    @java.lang.Override
