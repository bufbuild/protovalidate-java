...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      MapMinMax.class.getName());
  }
  // Use MapMinMax.newBuilder() to construct.
  private MapMinMax(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private MapMinMax() {
  }
  ...
  public static final class Builder extends
    ...
    public build.buf.validate.conformance.cases.MapMinMax getDefaultInstanceForType() {
      return build.buf.validate.conformance.cases.MapMinMax.getDefaultInstance();
    }

    @java.lang.Override
    public build.buf.validate.conformance.cases.MapMinMax build() {
      build.buf.validate.conformance.cases.MapMinMax result = buildPartial();
    ...
    private void buildPartial0(build.buf.validate.conformance.cases.MapMinMax result) {
  ...
  public static build.buf.validate.conformance.cases.MapMinMax getDefaultInstance() {
  ...
  @java.lang.Override
  public com.google.protobuf.Parser<MapMinMax> getParserForType() {
    return PARSER;
  }
