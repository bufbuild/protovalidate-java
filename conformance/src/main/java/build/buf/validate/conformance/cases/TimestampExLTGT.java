...
public final class TimestampExLTGT extends com.google.protobuf.GeneratedMessageV3
    implements
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return build.buf.validate.conformance.cases.WktTimestampProto
        ...
        .ensureFieldAccessorsInitialized(
            build.buf.validate.conformance.cases.TimestampExLTGT.class,
            build.buf.validate.conformance.cases.TimestampExLTGT.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.TimestampExLTGT other =
        (build.buf.validate.conformance.cases.TimestampExLTGT) obj;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public build.buf.validate.conformance.cases.TimestampExLTGT buildPartial() {
      build.buf.validate.conformance.cases.TimestampExLTGT result =
          new build.buf.validate.conformance.cases.TimestampExLTGT(this);
      if (bitField0_ != 0) {
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.TimestampExLTGT other) {
      if (other == build.buf.validate.conformance.cases.TimestampExLTGT.getDefaultInstance())
        return this;
      if (other.hasVal()) {
  ...
  private static final com.google.protobuf.Parser<TimestampExLTGT> PARSER =
      new com.google.protobuf.AbstractParser<TimestampExLTGT>() {
        @java.lang.Override
