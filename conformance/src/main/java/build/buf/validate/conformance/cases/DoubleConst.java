...
public final class DoubleConst extends com.google.protobuf.GeneratedMessageV3
    implements
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return build.buf.validate.conformance.cases.NumbersProto
        ...
        .ensureFieldAccessorsInitialized(
            build.buf.validate.conformance.cases.DoubleConst.class,
            build.buf.validate.conformance.cases.DoubleConst.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.DoubleConst other =
        (build.buf.validate.conformance.cases.DoubleConst) obj;
  ...
  public static build.buf.validate.conformance.cases.DoubleConst parseFrom(java.nio.ByteBuffer data)
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public build.buf.validate.conformance.cases.DoubleConst buildPartial() {
      build.buf.validate.conformance.cases.DoubleConst result =
          new build.buf.validate.conformance.cases.DoubleConst(this);
      if (bitField0_ != 0) {
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.DoubleConst other) {
      if (other == build.buf.validate.conformance.cases.DoubleConst.getDefaultInstance())
        return this;
      if (other.getVal() != 0D) {
        setVal(other.getVal());
      }
  ...
  private static final com.google.protobuf.Parser<DoubleConst> PARSER =
      new com.google.protobuf.AbstractParser<DoubleConst>() {
        @java.lang.Override
