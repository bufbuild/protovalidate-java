...
public interface RepeatedYetAnotherExternalEnumDefinedOrBuilder extends
   ...
   */
  java.util.List<build.buf.validate.conformance.cases.yet_another_package.Embed.Enumerated> getValList();
  /**
   * <code>repeated .buf.validate.conformance.cases.yet_another_package.Embed.Enumerated val = 1 [json_name = "val", (.buf.validate.field) = { ... }</code>
