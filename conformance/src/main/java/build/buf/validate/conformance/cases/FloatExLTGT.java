...
public final class FloatExLTGT extends com.google.protobuf.GeneratedMessageV3
    implements
  ...
  private FloatExLTGT(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return build.buf.validate.conformance.cases.NumbersProto
        ...
        .ensureFieldAccessorsInitialized(
            build.buf.validate.conformance.cases.FloatExLTGT.class,
            build.buf.validate.conformance.cases.FloatExLTGT.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.FloatExLTGT other =
        (build.buf.validate.conformance.cases.FloatExLTGT) obj;
  ...
  public static build.buf.validate.conformance.cases.FloatExLTGT parseFrom(java.nio.ByteBuffer data)
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public build.buf.validate.conformance.cases.FloatExLTGT buildPartial() {
      build.buf.validate.conformance.cases.FloatExLTGT result =
          new build.buf.validate.conformance.cases.FloatExLTGT(this);
      if (bitField0_ != 0) {
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.FloatExLTGT other) {
      if (other == build.buf.validate.conformance.cases.FloatExLTGT.getDefaultInstance())
        return this;
      if (other.getVal() != 0F) {
        setVal(other.getVal());
      }
  ...
  private static final com.google.protobuf.Parser<FloatExLTGT> PARSER =
      new com.google.protobuf.AbstractParser<FloatExLTGT>() {
        @java.lang.Override
