...
public final class FloatExGTELTE extends com.google.protobuf.GeneratedMessageV3
    implements
  ...
  private FloatExGTELTE(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return build.buf.validate.conformance.cases.NumbersProto
        ...
        .ensureFieldAccessorsInitialized(
            build.buf.validate.conformance.cases.FloatExGTELTE.class,
            build.buf.validate.conformance.cases.FloatExGTELTE.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.FloatExGTELTE other =
        (build.buf.validate.conformance.cases.FloatExGTELTE) obj;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public build.buf.validate.conformance.cases.FloatExGTELTE buildPartial() {
      build.buf.validate.conformance.cases.FloatExGTELTE result =
          new build.buf.validate.conformance.cases.FloatExGTELTE(this);
      if (bitField0_ != 0) {
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.FloatExGTELTE other) {
      if (other == build.buf.validate.conformance.cases.FloatExGTELTE.getDefaultInstance())
        return this;
      if (other.getVal() != 0F) {
        setVal(other.getVal());
      }
  ...
  private static final com.google.protobuf.Parser<FloatExGTELTE> PARSER =
      new com.google.protobuf.AbstractParser<FloatExGTELTE>() {
        @java.lang.Override
