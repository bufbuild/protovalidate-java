...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      RepeatedAnyIn.class.getName());
  }
  // Use RepeatedAnyIn.newBuilder() to construct.
  private RepeatedAnyIn(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    public build.buf.validate.conformance.cases.RepeatedAnyIn getDefaultInstanceForType() {
      return build.buf.validate.conformance.cases.RepeatedAnyIn.getDefaultInstance();
    }

    @java.lang.Override
    public build.buf.validate.conformance.cases.RepeatedAnyIn build() {
      build.buf.validate.conformance.cases.RepeatedAnyIn result = buildPartial();
    ...
    private void buildPartial0(build.buf.validate.conformance.cases.RepeatedAnyIn result) {
  ...
  public static build.buf.validate.conformance.cases.RepeatedAnyIn getDefaultInstance() {
  ...
  @java.lang.Override
  public com.google.protobuf.Parser<RepeatedAnyIn> getParserForType() {
    return PARSER;
  }
