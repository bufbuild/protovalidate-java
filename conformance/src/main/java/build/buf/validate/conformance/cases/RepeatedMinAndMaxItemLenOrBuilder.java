...
public interface RepeatedMinAndMaxItemLenOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:buf.validate.conformance.cases.RepeatedMinAndMaxItemLen)
   ...
   */
  java.util.List<java.lang.String> getValList();
