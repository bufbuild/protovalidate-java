...
public final class Embed extends com.google.protobuf.GeneratedMessageV3
  ...
  public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
    return build.buf.validate.conformance.cases.yet_another_package.Embed2Proto
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return build.buf.validate.conformance.cases.yet_another_package.Embed2Proto
        ...
        .ensureFieldAccessorsInitialized(
            build.buf.validate.conformance.cases.yet_another_package.Embed.class,
            build.buf.validate.conformance.cases.yet_another_package.Embed.Builder.class);
  }
  ...
  public enum Enumerated implements com.google.protobuf.ProtocolMessageEnum {
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor() {
      return build.buf.validate.conformance.cases.yet_another_package.Embed.getDescriptor()
          .getEnumTypes()
          .get(0);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    build.buf.validate.conformance.cases.yet_another_package.Embed other =
        (build.buf.validate.conformance.cases.yet_another_package.Embed) obj;
  ...
  public static Builder newBuilder(
      build.buf.validate.conformance.cases.yet_another_package.Embed prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    @java.lang.Override
    public build.buf.validate.conformance.cases.yet_another_package.Embed
    ...
    public build.buf.validate.conformance.cases.yet_another_package.Embed buildPartial() {
      build.buf.validate.conformance.cases.yet_another_package.Embed result =
          new build.buf.validate.conformance.cases.yet_another_package.Embed(this);
      if (bitField0_ != 0) {
    ...
    public Builder mergeFrom(build.buf.validate.conformance.cases.yet_another_package.Embed other) {
      if (other
          == build.buf.validate.conformance.cases.yet_another_package.Embed.getDefaultInstance())
        return this;
      if (other.getVal() != 0L) {
        setVal(other.getVal());
      }
  ...
  private static final build.buf.validate.conformance.cases.yet_another_package.Embed
      DEFAULT_INSTANCE;
  ...
  public static build.buf.validate.conformance.cases.yet_another_package.Embed
      getDefaultInstance() {
